export const BANNER_HOME = "src/assets/bannerHome.png";

export const CATEGORIES = [
  {
    image: "src/assets/categories/image2.png",
    name: "Todos",
  },
  {
    image: "src/assets/categories/image1.png",
    name: "Cultura",
  },
  {
    image: "src/assets/categories/image2.png",
...
export const CARACTERISTICAS = [
  ...
  {
    icon: "src/assets/icons/ver.png",
    name: "Miradores cercanos",
  },
  {
    icon: "src/assets/icons/mountain.png",
    name: "Zona de acampado",
  },
  {
    icon: "src/assets/icons/guia.png",
    name: "Guia incluido",
  },
];
